...
class job_baseDescriptor : public omnetpp::cClassDescriptor
{
  private:
...
Register_ClassDescriptor(job_baseDescriptor)

job_baseDescriptor::job_baseDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(job_base)), "")
{
    propertyNames = nullptr;
}

job_baseDescriptor::~job_baseDescriptor()
{
    delete[] propertyNames;
}

bool job_baseDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<job_base *>(obj)!=nullptr;
}

const char **job_baseDescriptor::getPropertyNames() const
{
    if (!propertyNames) {
...
const char *job_baseDescriptor::getProperty(const char *propertyName) const
{
...
int job_baseDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? 0+base->getFieldCount() : 0;
}

unsigned int job_baseDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
...
const char *job_baseDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int job_baseDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    return base ? base->findField(fieldName) : -1;
}

const char *job_baseDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char **job_baseDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *job_baseDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int job_baseDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void job_baseDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *job_baseDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string job_baseDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void job_baseDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
omnetpp::cValue job_baseDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void job_baseDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *job_baseDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
omnetpp::any_ptr job_baseDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void job_baseDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
void Job::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->job);
}

void Job::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->job);
}

const job_base * Job::getJob() const
{
    return this->job;
}

void Job::setJob(job_base * job)
{
    this->job = job;
}
...
unsigned int JobDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISCOMPOUND | FD_ISPOINTER | FD_ISREPLACEABLE,    // FIELD_job
    };
...
int JobDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "job") == 0) return baseIndex + 0;
    return base ? base->findField(fieldName) : -1;
}
...
const char *JobDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Job *pp = omnetpp::fromAnyPtr<Job>(object); (void)pp;
    switch (field) {
        case FIELD_job: { const job_base * value = pp->getJob(); return omnetpp::opp_typename(typeid(*value)); }
        default: return nullptr;
    }
}
...
omnetpp::cValue JobDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Job *pp = omnetpp::fromAnyPtr<Job>(object); (void)pp;
    switch (field) {
        case FIELD_job: return omnetpp::toAnyPtr(pp->getJob()); break;
...
void JobDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    Job *pp = omnetpp::fromAnyPtr<Job>(object); (void)pp;
    switch (field) {
        case FIELD_job: pp->setJob(omnetpp::fromAnyPtr<job_base>(value.pointerValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Job'", field);
    }
}
...
const char *JobDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case FIELD_job: return omnetpp::opp_typename(typeid(job_base));
        default: return nullptr;
    };
}
...
void JobDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    ...
    Job *pp = omnetpp::fromAnyPtr<Job>(object); (void)pp;
    switch (field) {
        case FIELD_job: pp->setJob(omnetpp::fromAnyPtr<job_base>(ptr)); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Job'", field);
    }
}
